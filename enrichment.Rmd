...
This is the list of all the genes you tested in your RNAseq pipeline. Recall that
you only tested genes on a single chromosome, so there will be many genes
with ‘NAs’ for those that were not tested.

1. Filter and Sort -> Filter
2. Select the DESeq2 results from the previous step
...
3. Choose Organism: `Saccharomyces cerevisiae`
